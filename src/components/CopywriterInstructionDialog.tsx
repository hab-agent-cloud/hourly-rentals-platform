...
• Добавление отеля с несколькими категориями номеров: 100 ₽ за объект
• Добавление апартамента: 50 ₽ за объект
...
• Минимум часов: укажите минимальное время аренды (обычно 2 часа)
  ВАЖНО! 90% собственников предпочитают сдачу от 1 часа
