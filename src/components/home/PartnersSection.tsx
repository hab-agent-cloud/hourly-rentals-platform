            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Владельцы оформляют подписку для размещения на сайте, используют все инструменты продвижения с подпиской. Некоторые продвижения являются платной услугой.
                </p>
              </div>
            </div>
          </CardContent>
