    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Почасовая аренда отеля — это возможность арендовать номер на несколько часов (от 2 часов) вместо традиционных суток. Это удобно для деловых встреч, отдыха между поездками или краткосрочного размещения."
        }
      },
      {
        "@type": "Question",
