    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Получите 5000 бонусных рублей при регистрации и добавлении объекта на сайт. Списывайте без ограничений бонусные рубли на продвижение и подписку, где 1 бонусный рубль = 1 рублю
          </CardDescription>
        </CardHeader>
        <CardContent>
